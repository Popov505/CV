...
<html lang="fr">
    <head>
      ...
      <link rel="stylesheet" href="/public/styles/portfolio.css" type="text/css">
    </head>
        ...
        <article class="portfolio pale-theme">
          ...
          <section class="project">
            ...
            <a class="link" href="https://sprightly-madeleine-71aee9.netlify.app/" target="_blank">
              <img class="image" src="/public/images/illustrations/illustration-croisty-bats.webp" alt="Illustation du site du club de roller derby : les Croisty Bats">
            </a>
            <p class="description">
          ...
          <section class="project">
            ...
            <a class="link" href="https://quiet-pixie-aa5271.netlify.app/" target="_blank">
              <img class="image" src="/public/images/illustrations/illustration-des.webp" alt="Illustation du site de jeu de dés">
            </a>
            <p class="description">
          ...
          <section class="project">
            ...
            <a class="link" href="https://ecf-nutritionniste-symfony-1bf4cc814a3e.herokuapp.com/" target="_blank">
              <img class="image" src="/public/images/illustrations/illustration-nutritionniste.webp" alt="Illustation du site de Sandrine Coupart : 
          ...
          <section class="project">
            ...
            <a class="link" href="https://v-parrot-garage-e709d2d1efba.herokuapp.com/" target="_blank">
              <img class="image" src="/public/images/illustrations/illustration-garage.webp" alt="Illustation du site garage de Vincent Parrot">
            </a>
            <p class="description">
